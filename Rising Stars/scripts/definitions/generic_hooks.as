...
tidy class GenericEffect : Hook, IResourceHook, IBuildingHook, IStatusHook, IOrbitalEffect, SubsystemHook, RegionChangeable, LeaderChangeable {
	...
	void save(Resource@ r, any@ data, SaveFile& file) const { save(data, file); }
	void load(Resource@ r, any@ data, SaveFile& file) const { load(data, file); }
	bool shouldVanish(Object& obj, Resource@ native) const { return false; }
	void onAdd(Object& obj, Resource@ r, any@ data) const { enable(obj, data); }
	void onRemove(Object& obj, Resource@ r, any@ data) const { disable(obj, data); }
	void onTick(Object& obj, Resource@ r, double time, any@ data) const { tick(obj, data, time); }
	...
	void onRegionChange(Object& obj, Resource@ r, Region@ fromRegion, Region@ toRegion, any@ data) const {
		regionChange(obj, data, fromRegion, toRegion);
	}
	...
	void complete(Object& obj, SurfaceBuilding@ bld, any@ data) const { enable(obj, data); }
	void remove(Object& obj, SurfaceBuilding@ bld, any@ data) const { disable(obj, data); }
