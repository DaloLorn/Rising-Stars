			...
			if (next !is null)
			{
				...
				switch (next.action) {
					case BA_BuildOutpost:
						switch (next.loc) {
							case BL_InSystem:
								sys.buildInSystem(this, construction, ai.defs.EconomyCore, next.priority, next.force);
								break;
							case BL_AtSystemEdge:
								sys.buildAtSystemEdge(this, construction, ai.defs.EconomyCore, next.priority, next.force);
								break;
							case BL_AtBestPlanet:
									@obj = getBestPlanet(sys);
									if (obj !is null) {
										sys.buildAtPlanet(this, construction, cast<Planet>(obj), ai.defs.EconomyCore, next.priority, next.force);
									}
								break;
							default:
